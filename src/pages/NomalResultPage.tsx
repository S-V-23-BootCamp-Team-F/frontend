...
const NomalResultPage = () => {
  return (
    ...
    <div className=" flex min-h-screen w-full flex-col overflow-y-auto bg-background bg-grass bg-no-repeat">
      ...
      <Navbar />
      {/* 본문 */}
      <div className="mt-40 flex place-content-evenly content-center items-center px-12 pt-4 md:flex-row ">
        {/* 왼쪽 */}
        ...
        <div className="place-content-center">
          ...
          <img src={nomal} className="object-cover" />
          <div className="mt-24 font-kor-bold text-2xl">
            우리의 작물은 건강합니다.
          </div>
        </div>
      </div>
