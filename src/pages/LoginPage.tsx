        ...
        <div className = "flex justify-center m-10">
            <div className="w-600 h-750 rounded-xl bg-black bg-opacity-30">
                ...
                <div className="flex justify-between mt-7">
                    <div className="m-7 justify-self-start text-white font-press-bold max-xs:text-xl text-2xl ml-24">
                        Sign up
                    </div>
                    <div className="m-7 justify-self-end text-white font-press-bold max-xs:text-xl text-2xl mr-24">
                        Sign in
                    </div>
                </div>
