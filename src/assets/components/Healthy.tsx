...
function Healthy() { 
    {
        return (
            <div className="w-60 h-72 border-2 border-project-green relative flex justify-center items-center rounded-lg bg-white">
                {/*이미지*/}
                ...
                {/*질병*/}
                <span className="top-52 absolute text-xl text-project-green">정상</span>
                {/*날짜*/}
